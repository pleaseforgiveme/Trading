...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108655&cbuster=1258064462&x=SEKXLEN&y=SEKYLEN&cbuster=1680742294',
					origQString: 's=108655&cbuster=1258064462',
					placementId: 108655,
					x: 300,
					y: 250,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"macOS","osVersion":"10.15","osVersionMajor":"10","osVersionMinor":"15","deviceManufacturer":"Apple","deviceModel":"Macintosh","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"111.0.0.0","browserVersionMajor":"111","browserVersionMinor":"0","chromeVersion":"111"},"browser":"chrome","os":"macosx","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'CA',
					dmaCode: 0,
					dynamicSetup: [["floatSetup",[{"screenWidthSize":"1536","enabled":1,"width":"401","direction":"bl","verticalOffset":"5","horizontalOffset":"10","isCloseBtn":1,"flowMode":"below","closeBtnPos":"right"},{"screenWidthSize":"480","enabled":1,"width":"300","direction":"bl","verticalOffset":"5","horizontalOffset":"10","isCloseBtn":1,"flowMode":"below","closeBtnPos":"right"},{"screenWidthSize":"0","enabled":0,"width":"300","direction":"bl","verticalOffset":"5","horizontalOffset":"10","isCloseBtn":true,"flowMode":"below","closeBtnPos":"right"}]]],
					uuid: '642e1796a6b1f',
					isResponsiveBanner: false,
					hideOnMissingMainElement: false,
					allowedUtmParameters: [],
					allowDisplaySamePlacementAgain: true,
					searchMetaTagNames: {"tagAttribute":"property","tagName":"og:url"},
